  ...
  render () {
    return this.state.activityIndicatorTemp ? (
      ...
      <View style={{
        ...
        <Header searchIcon={true} backIcon={this.props.navigation.dangerouslyGetParent().state.index >= 0} menuIcon={!(this.props.navigation.dangerouslyGetParent().state.index >= 1)} cartIcon={true} navigation={this.props.navigation} name={this.props.language.Category} navigation={this.props.navigation} />
