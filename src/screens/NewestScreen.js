...
class Newest extends PureComponent {
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      tempmYarray: [0, 500],
      tempmYarray2: [0, 500],
      sortArray: [this.props.language.newest, this.props.language['A - Z'],
        this.props.language['Z - A'], this.props.language['price : high - low'],
  ...
  getProducts = async () => {
    ...
    if (this.props.navigation.dangerouslyGetParent() !== null &&
      this.props.navigation.dangerouslyGetParent() !== undefined) {
      if (this.props.navigation.dangerouslyGetParent().state.params.brand === 'brandId') {
    ...
    if (this.props.navigation.dangerouslyGetParent() !== null &&
      this.props.navigation.dangerouslyGetParent() !== undefined) {
      if (this.props.navigation.dangerouslyGetParent().state.params.brand === 'isFeatured') {
        Object.assign(object, { featured: true })
      }
    }

    if (this.state.selectedTab !== '' && this.state.selectedTab !== 0 && this.state.selectedTab !== undefined) {
      Object.assign(object, { category: this.state.selectedTab })
    }

    if (this.state.applyFilter === true) {
      if (this.state.price.lower !== 0 || this.state.price.upper !== this.state.maxAmount) {
        Object.assign(object, {
  ...
  getSortProducts (value) {
    ...
    if (value === 'newest') { value = 'date'; this.state.sortType = 'asc' } else if (value === 'a - z') { value = 'title'; this.state.sortType = 'asc' } else if (value === 'z - a') { value = 'title'; this.state.sortType = 'desc' } else if (value === 'price : high - low') { value = 'price'; this.state.sortType = 'desc' } else if (value === 'price : low - high') { value = 'price'; this.state.sortType = 'asc' } else if (value === 'on sale') { value = 'date'; this.state.sortType = 'asc' } else if (value === 'featured') { value = 'date'; this.state.sortType = 'asc' }
