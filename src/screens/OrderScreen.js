...
import { postFetchHttp } from '../common/WooComFetch'
...
class ShippingAddress extends PureComponent {
  ...
  saveFun () {
    this.props.navigation.push('WebViewScreen'
      , {
        methodType: this.props.navigation.state.params.methodType,
        methodName: this.props.navigation.state.params.methodName,
        orderNote: this.state.customerNotes
      }
    )
    // })
  }
  ...
  calculateTotal () {
    return (this.props.cartTotalFloat + parseFloat(this.props.shippingLines[0].total)) + this.state.tax
  };
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView
        ...
        <View style={[styles.viewContainer, {
          ...
          {this.singleRow(this.props.language['Shipping Method'], this.props.navigation.state.params.methodName, true)}
