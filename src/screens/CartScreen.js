        ...
        <View
          ...
          <View style={{
            ...
            <Text style={[styles.priceText, {
              ...
              {'-' + this.props.currencySymbol + ' ' + this.state.cartDiscountFloat.toFixed(2)}
            </Text>
          </View>
            ...
            ListHeaderComponent={
              <View style={styles.headerListStyle}>
                ...
                <TouchableOpacity onPress={() => {
                  this.props.navigation.push('NewestScreen', { brand: 'brandId' })
                }}>
...
const mapDispatchToProps = dispatch => ({
  checkCouponAvalabilityFun: (text, th) => {
    dispatch(async dispatch => {
      await checkCouponAvalability(dispatch, text, th, th.props.languageCode,
  ...
  deleteProductFromCartCall: (id, sessionId, combinationId, qty, th) => {
    dispatch(async dispatch => {
      await deleteProductFromCart(dispatch, id, sessionId, combinationId, qty, th, th.props.languageCode,
        th.props.currencyCode)
    })
  },
  getCartProductsCall: (sessionId, th) => {
    dispatch(async dispatch => {
      await getCartProducts(dispatch, sessionId, th, th.props.languageCode,
        th.props.currencyCode)
    })
  },
  delCaupon: (code) => {
