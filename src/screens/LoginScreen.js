...
class Login extends PureComponent {
  ...
  canBeSubmitted () {
    const { lastNameSignUp, firstNameSignUp, confirmPasswordSignUp, emailSignUp, passwordSignUp, userName } = this.state
    return (
...
const mapDispatchToProps = dispatch => ({
  signUpCall: (firstNameSignUp, lastNameSignUp, userName, emailSignUp, passwordSignUp, confirmPasswordSignUp
    , th, sessionId) => {
    dispatch(async dispatch => {
      await signUp(dispatch, firstNameSignUp, lastNameSignUp, userName, emailSignUp, passwordSignUp, confirmPasswordSignUp, th,
        sessionId, th.props.languageCode,
        th.props.currencyCode)
    })
  },
  signInCall: (emailSignIn, passwordSignIn, sessionId, th) => {
    dispatch(async dispatch => {
      await signIn(dispatch, emailSignIn, passwordSignIn, sessionId, th, th.props.languageCode,
        th.props.currencyCode)
    })
  },
